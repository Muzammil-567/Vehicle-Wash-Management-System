document.addEventListener('DOMContentLoaded', () => {
    // Basic Components
    loadComponent('navbar-placeholder', '../../shared_widgets/navbar.html', () => {
        initNavbar();
        initSmoothScrolling();
        initActiveLinkTracking();
    });
    loadComponent('footer-placeholder', '../../shared_widgets/footer.html');

    // Section Components
    loadComponent('hero-placeholder', '../../shared_widgets/hero-section.html');
    loadComponent('services-placeholder', '../../shared_widgets/services-section.html');
    loadComponent('pricing-placeholder', '../../shared_widgets/pricing-section.html');
    loadComponent('about-stats-placeholder', '../../shared_widgets/about-stats-section.html');
    loadComponent('testimonials-placeholder', '../../shared_widgets/testimonials-gallery.html');
    loadComponent('contact-placeholder', '../../shared_widgets/contact-section.html', initScrollAnimations);
});
