...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    await loadComponent('duty-status-sidebar-placeholder', '/frontend/employee/html/employee_components/duty-status.html');
...
async function switchTab(tabName) {
    ...
    setTimeout(async () => {
        if (tabName === 'tasks') {
            ...
            await loadComponent('task-list-placeholder', '/frontend/employee/html/employee_components/profile-view.html');
        }
...
/**
 * Notification Drawer Logic (Toggle Open/Close)
 */
